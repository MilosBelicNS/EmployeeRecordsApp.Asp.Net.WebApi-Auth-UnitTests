...
class RegLogForms extends Component {
    ...
    register = () => { //register metoda
        ...
        axios("https://localhost:44311/api/Account/Register", { //komanda za ajax
            method: "POST",
            data: registerData
        }).then(() => {
    ...
    login = () => {
        fetch("https://localhost:44311/Token", { 
            method: "POST",
            ...
            <div className= "container">
                ...
                <div className='row'>
                  ...
                  <form className="form-horizontal" style={{ marginLeft:'36%', marginTop: "10%"}}>
                        <h3 style={{color:'orange', backgroundColor:'darkslategray', textAlign:'center'}}>Register and login</h3>
                        <br/>
                  ...
                  <br />
                         <div className='form-inline'>
                             <label style={{marginRight:'10px'}}> <strong> Password: </strong> </label>
                               <div className='col-sm-8'>
                                 <input style={{marginLeft:'45px', width:'100%'}}
                                        type="password"
                ...
                {this.state.isLog ? null : <div className='form-inline'>
                 ...
                 <br />
                             ...
                             <button onClick={this.navigateBack} className="btn btn-warning" style={{ marginLeft: "15px" }}> Back </button> 
