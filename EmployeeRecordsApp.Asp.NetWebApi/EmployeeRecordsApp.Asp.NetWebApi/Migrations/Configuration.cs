    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EmployeeRecordsApp.Asp.NetWebApi.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(EmployeeRecordsApp.Asp.NetWebApi.Models.ApplicationDbContext context)
        {
            ...
            context.Employee.AddOrUpdate(
                ...
                new Employed() { Name = "Pera Peric", Role = "Software developer", Birth = 1994, EmploymentYear = 2006, Salary = 5000, TeamId = 1 },
                new Employed() { Name = "Pera Peric", Role = "Manger", Birth = 1982, EmploymentYear = 2009, Salary = 4500, TeamId = 3 },
                new Employed() { Name = "Pera Peric", Role = "Software developer", Birth = 1990, EmploymentYear = 2015, Salary = 6000, TeamId = 1 });
